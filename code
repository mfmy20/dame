    ...
    if a_manger:
        for d in a_manger:
            ...
            for c in jeton_blanc_simule:
                list_jeton_simule2.append(copy.deepcopy(c))
                jeton_blanc_simule2.append(copy.deepcopy(c))
            for c in jeton_blanc_simule:
                list_jeton_simule2.append(copy.deepcopy(c))
                jeton_blanc_simule2.append(copy.deepcopy(c))
            val = Min(d,list_jeton_simule2,jeton_blanc_simule2,jeton_noir_simule2,profondeur-1)
            if val > maxval or val == maxval and random.randint(1,2) == 2:
                maxval = val
                MeilleurCoup = d
    else:
        if player == "white":
        ...
        for c in jeton_doit_joue:
            ...
            for d in case_possible:
                ...
                for c in jeton_blanc_simule:
                    list_jeton_simule2.append(copy.deepcopy(c))
                    jeton_blanc_simule2.append(copy.deepcopy(c))
                val = Min(action,list_jeton_simule2,jeton_blanc_simule2,jeton_noir_simule2,profondeur-1)
                if val > maxval or val == maxval and random.randint(1,2) == 2:
                    maxval = val
                    MeilleurCoup = action
    print(MeilleurCoup)
...
def Min(d,list_jeton_simule,jeton_blanc_simule,jeton_noir_simule,profondeur):
        ...
        if a_manger:
            for d in a_manger:
                ...
                for c in jeton_blanc_simule:
                    list_jeton_simule2.append(copy.deepcopy(c))
                    jeton_blanc_simule2.append(copy.deepcopy(c))
                val = Min(d,list_jeton_simule2,jeton_blanc_simule2,jeton_noir_simule2,profondeur)
                if val > maxval or val == maxval and random.randint(1,2) == 2:
                    maxval = val
            return maxval
    else:
    ...
    if profondeur == 0 or not jeton_blanc_simule or not jeton_noir_simule or not jeton_doit_joue:
        return evaluer(list_jeton_simule,jeton_blanc_simule,jeton_noir_simule)
    else:
        if a_manger:
            for d in a_manger:
                list_jeton_simule2 = []
            ...
            for c in jeton_doit_joue:
                ...
                for d in case_possible:
                    ...
                    for c in jeton_blanc_simule:
                        list_jeton_simule2.append(copy.deepcopy(c))
                        jeton_blanc_simule2.append(copy.deepcopy(c))
                    val = Max(action,list_jeton_simule2,jeton_blanc_simule2,jeton_noir_simule2,profondeur-1)
                    if val < minval or val == minval and random.randint(1,2) == 2:
                        minval = val
    return minval
...
def evaluer(list_jeton_simule,jeton_blanc_simule,jeton_noir_simule):
    val = 0
    for c in jeton_blanc_simule:
        tag = c[4]
        if player == "white":
...
def fin_tour():
    global couleur,jeton_doit_joue
    if couleur == "blanc":
        couleur = "noir"
        z = MinMax()
        coord = plateau.coords(z[0][0])
        print(coord,list_jeton)
        jeton_doit_joue = doit_noir_manger()
        if jeton_doit_joue:
            None
        else:
